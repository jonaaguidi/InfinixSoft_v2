...
const Hero = ({ video, title, subtitle, buttonText }) => {
      ...
      <section id='hero' className="px-14 z-20 h-[85vh] flex flex-col justify-center items-center relative max-[520px]:px-7 max-[520px]:pb-20">
        ...
        <div className="flex flex-col items-center z-20 w-full text-center text-white">
          <div className="py-10">
            ...
            <h5 className="text-[18px] leading-[150%] max-w-[530px] mx-auto text-shadow-md max-[1000px]:text-[18px] max-[590px]:text-[16px] max-[520px]:text-[16px]">{subtitle}</h5>
          </div>
          <button
