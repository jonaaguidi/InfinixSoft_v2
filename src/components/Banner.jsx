...
const Banner = () => {
  ...
  return (
    <div className="w-full h-fit px-28 py-16 z-20 flex flex-wrap items-center justify-center gap-24 max-[880px]:px-14 max-[466px]:py-12 max-[466px]:px-7 max-[466px]:gap-16">
      {isMobile ? (
