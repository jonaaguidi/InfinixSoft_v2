...
const Dropdown_Holding = () => {
  return (
    <div  className="animate-fade-up animate-duration-[650ms] animate-delay-25 w-fit border-2 border-[#313134] bg-black shadow-navbar p-3 rounded-md absolute top-[136px] left-48 max-[580px]:left-16">
