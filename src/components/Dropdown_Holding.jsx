...
const Dropdown_Holding = () => {
  return (
    <div  className="animate-fade-up animate-duration-[650ms] animate-delay-25 w-fit border-2 border-[#313134] bg-[#171718] shadow-navbar p-2 rounded-md absolute top-[96px] left-48 max-[580px]:left-16">
