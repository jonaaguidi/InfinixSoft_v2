...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      <Script src="https://js.hscollectedforms.net/collectedforms.js" type="text/javascript" id="CollectedForms-22404315" crossorigin="anonymous" data-leadin-portal-id="22404315" data-leadin-env="prod" data-loader="hs-scriptloader" data-hsjs-portal="22404315" data-hsjs-env="prod" data-hsjs-hublet="na1" />
      <body>{children}</body>
    </html>
  )
}
